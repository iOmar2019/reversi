...
$(function() {
  ...
  $('#quit').append('<a href="lobby.html?username='+username+' " class="btn btn-danger btn-default active" role="button" arial-pressed="true">Quit</a>');
...
socket.on('game_update', function(payload) {
  ...
  if(socket.id == payload.game.player_white.socket){
    ...
    /* Something weird is going on, likle three people playing at once */
...
socket.on('game_over', function(payload) {
  ...
  if(payload.result == 'fail') {
   ...
   $('#game_over').append('<a href="lobby.html?username='+username+' " class="btn btn-success btn-lg active" role="button" arial-pressed="true">Return to the lobby</a>');
});
